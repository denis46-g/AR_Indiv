...
class HelloGeoView(val activity: HelloGeoActivity) : DefaultLifecycleObserver {
  ...
  val buttonSelf: Button = root.findViewById<Button>(R.id.buttonSelf)
    ...
    val homeButton: Button = root.findViewById<Button>(R.id.homeButton)
    val saveButton: Button = root.findViewById<Button>(R.id.saveButton)

    // Home Menu
    val homeMenuTextView: TextView = root.findViewById<TextView>(R.id.HomeView)
    val playArSessionButton: Button = root.findViewById<Button>(R.id.playARSessionButton)
    val settingsButton: Button = root.findViewById<Button>(R.id.settingsButton)

    // Settings
    val settingsTextView: TextView = root.findViewById<TextView>(R.id.SettingsView)
    val backButton: Button = root.findViewById<Button>(R.id.buttonBack)
    val model1Button: Button = root.findViewById<Button>(R.id.buttonModel1)
    val model2Button: Button = root.findViewById<Button>(R.id.buttonModel2)
